...
public class IndividualView extends ActionBarActivity implements OnClickListener {
	...
	public void onUpSwipe() throws ParseException
	{
	    ...
	    configureNextSet(incrementedString, nextLift, viewMode, mode);//poodles
	...
	public void onDownSwipe() throws ParseException
	{
	    ...
	    configurePreviousSet(incrementedString, nextLift, viewMode, mode);
	...
	public void configureNextSet(String myDate, String myNextLift, String viewMode, String lbMode)
	{
	...
	public void configurePreviousSet(String myDate, String myPrevLift,  String viewMode, String mode)
	{
