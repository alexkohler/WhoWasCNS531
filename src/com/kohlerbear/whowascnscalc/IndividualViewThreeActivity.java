...
public class IndividualViewThreeActivity extends Activity implements OnClickListener {
...
//		String secondLiftString = intent.getStringExtra("secondLift");
		...
		configureBarbell(thirdLiftString, barbellImageView, relativeLayout, boolArray);
		dateTV.setText(date);
	...
	public void configureBarbell(String myThirdLiftString, ImageView barbellImageView, RelativeLayout relativeLayout, boolean[] booleanArray)
	{
		//lbNeeded declarations
				...
				String thirdLiftString = myThirdLiftString;
				firstLift = Double.valueOf(thirdLiftString);
				if (getLbMode())
				{
		            boolean 
		           ...
		           lbHaveTwoPointFive = booleanArray[5]; 	
					...
					else
					{
						...
						relativeLayout.setOnClickListener(IndividualViewThreeActivity.this); 
...
//						ConfigTool helper = new ConfigTool(IndividualView.this);
	...
	public void onBackPressed() {
	   IndividualViewThreeActivity.this.finish();
	}
	...
	public void dynamicAddPlate(int resource)
	{
		...
		//Right/left 45 Setup
		CURRENT_RIGHT_IMAGEVIEW = new ImageView(IndividualViewThreeActivity.this);
		CURRENT_LEFT_IMAGEVIEW = new ImageView(IndividualViewThreeActivity.this);
